...
public class SegTree {
    ...
    // the input array.
    // val --> Value that has to be added to all of the nodes which have j in the
    // range
    ...
    // A recursive method that does the construction of the Segment Tree for the
    // array
    // a[x ... y].
    ...
    public static void main(String argvs[]) {
        ...
        System.out.println("Sum of values in the given range 0 to 4 = " + tree.getSum(size, 0, 4));
        // Update: setting arr[3] = 11 and updating the corresponding segment
        // of the tree nodes
        tree.updateVal(a, size, 3, 3);
        tree.updateVal(a, size, 8, -3);

        System.out.println("Updated sum of values in the given range = " + tree.getSum(size, 0, 3));

        tree.updateVal(a, size, 4, 0);
        tree.updateVal(a, size, 4, 0);

        System.out.println("Updated sum of values in the given range = " + tree.getSum(size, 0, 4));

        tree.updateVal(a, size, 2, 0);
        // tree.updateVal(a, size, 5, -8);

        // Finding the sum after the value is getting updated
        System.out.println("Updated sum of values in the given range = " + tree.getSum(size, 0, 2));
    }
}